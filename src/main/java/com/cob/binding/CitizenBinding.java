...
public class CitizenBinding {
	...
	public String toString() {
		return "CitizenBinding [citizenName=" + citizenName + ", citizenIncome=" + citizenIncome + ", citizenAge="
				+ citizenAge + ", haveKidsLessThan16=" + haveKidsLessThan16 + ", insurancePlanName=" + insurancePlanName
				+ "]";
	}
